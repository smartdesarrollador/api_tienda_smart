...
class StoreDireccionValidadaRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'zona_reparto_id' => 'nullable|exists:zonas_reparto,id',
            'latitud' => 'required|numeric|between:-90,90',
            'longitud' => 'required|numeric|between:-180,180',
            'distancia_tienda_km' => 'nullable|numeric|min:0|max:1000',
            'en_zona_cobertura' => 'required|boolean',
            'costo_envio_calculado' => 'nullable|numeric|min:0|max:999.99',
            'tiempo_entrega_estimado' => 'nullable|integer|min:1|max:1440',
    ...
    public function messages(): array
    {
        return [
            ...
            'en_zona_cobertura.required' => 'Se debe especificar si está en zona de cobertura.',
